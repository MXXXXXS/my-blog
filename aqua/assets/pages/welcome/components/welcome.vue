  ...
  <div id="container">
    ...
    <div id="content">
      <div id="settings">
        ...
        <div class="colorPicker" :class="{pickerRotation: rotate}">
      ...
      <div class="home">
        ...
        >
          <path
            d="M1024 372.363636v651.636364H605.090909V744.727273a93.090909 93.090909 0 1 0-186.181818 0v279.272727H0V372.363636L512 0l512 372.363636zM674.909091 954.181818h279.272727V414.673455L512 93.090909 69.818182 414.673455V954.181818h279.272727v-209.454545a162.909091 162.909091 0 0 1 325.818182 0v209.454545z"
          ></path>
        </svg>
        <div class="article">
          <div class="content" :style="{color: themeColor}" v-html="article"></div>
          <comment :theme-color="themeColor" class="commentBox"></comment>
        </div>
      </div>
      <div id="about">
        <svg class="me" viewBox="0 0 1024 1024" version="1.1" width="200" height="200">
          <path
